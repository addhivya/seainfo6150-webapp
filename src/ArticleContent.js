...
const ArticleContent = () => (
   <div>
        ...
        <p> <b> "Although it is not one of the most difficult things we have ever moved," </b>says <i>Douglas Phelps</i>, who oversaw the relocation of the torch, <b>"it is certainly the most important." </b></p>

        <p> Not only is the Statue of Liberty the symbol of New York City, she is also a UNESCO World Heritage site under the designation of <b>"Outstanding Universal Value." </b></p>

        <p>Her full name is Liberty Enlightening the World, and she was designed by Frederic Auguste Bartholdi and built by <i>Gustave Eiffel</i> -- yes, the same guy who built Paris's Eiffel Tower.</p>
